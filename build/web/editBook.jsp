				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">				
							...
							<li><a href="add_newProduct.jsp">Add New Product</a></li>
                      ...
                      <th></th>
                            ...
                            <tr>
                               <td><input type="text" name="booking_id" value="<%=rs.getString(1)%>"></td>
                                ...
                                <td><input type="text" name="delivery_boy" value="<%=rs.getString(10)%>"size="10"></td>
                                <td><input type="hidden" name="weight" value="<%=rs.getString(11)%>"size="10"></td>
                                <td><input type="hidden" name="price" value="<%=rs.getString(12)%>"size="10"></td>
                                   <td><input type="hidden" name="status" value="<%=rs.getString(13)%>"size="10"></td>
